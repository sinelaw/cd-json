            ...
            completer: function completer(line) {
                ...
                for (cmd in me.commands) {
                    ...
                    if (cmd === commandPartOfLine) {
                        completions = getPropertyNames(me.context.json).map(prefixSpace);
                        completions.push(' .');
                        completions.push(' ..');
    ...
    me.commands = {
        ...
        cat: {
            ...
            action: function () {
                ...
                for (i in arguments) {
                    target = arguments[i];
                    console.log(getContextFromJson(target).json);
                }
            }
        },
        ...
        ls: {
            ...
            action: function () {
                ...
                for (i in arguments) {
                    target = arguments[i];
                    context = getContextFromJson(target);
